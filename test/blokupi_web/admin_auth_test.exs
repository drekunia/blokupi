defmodule BlokupiWeb.AdminAuthTest do
  use BlokupiWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Blokupi.Operations
  alias BlokupiWeb.AdminAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BlokupiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BlokupiWeb.Endpoint.subscribe(live_socket_id)
