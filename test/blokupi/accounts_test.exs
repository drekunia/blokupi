defmodule Blokupi.AccountsTest do
  ...
  describe "change_user_registration/2" do
    test "returns a changeset" do
      ...
      assert changeset.required == [:uri, :password, :email, :username]
    end
  ...
  describe "reset_user_password/2" do
    ...
    test "updates the password", %{user: user} do
      {:ok, updated_user} = Accounts.reset_user_password(user, %{password: "New Valid Password 123"})
