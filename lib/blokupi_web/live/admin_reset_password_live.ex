defmodule BlokupiWeb.AdminResetPasswordLive do
  ...
  def handle_event("reset_password", %{"admin" => admin_params}, socket) do
    case Operations.reset_admin_password(socket.assigns.admin, admin_params) do
      {:ok, _} ->
        {:noreply,
         socket
  ...
  def handle_event("validate", %{"admin" => admin_params}, socket) do
    changeset = Operations.change_admin_password(socket.assigns.admin, admin_params)
